...
class TemplateCompletionProvider {
    ...
    async onComplete(root, params) {
        ...
        try {
            if ((0, ast_helpers_1.isFirstParamOfOnModifier)(focusPath)) {
                const tagName = (_a = focusPath.parentPath) === null || _a === void 0 ? void 0 : _a.parent;
                if ((tagName === null || tagName === void 0 ? void 0 : tagName.type) === 'ElementNode') {
            ...
            else if ((0, ast_helpers_1.isSpecialHelperStringPositionalParam)('component', focusPath)) {
                // (component "foo...")
            ...
            else if ((0, ast_helpers_1.isAngleComponentPath)(focusPath)) {
                ...
                const grandPaparentNode = (_c = (_b = focusPath.parentPath) === null || _b === void 0 ? void 0 : _b.parentPath) === null || _c === void 0 ? void 0 : _c.node;
                ...
                const grandPaparentNode = (_f = (_e = (_d = focusPath.parentPath) === null || _d === void 0 ? void 0 : _d.parentPath) === null || _e === void 0 ? void 0 : _e.parentPath) === null || _f === void 0 ? void 0 : _f.node;
