...
export declare function isFirstParamOfOnModifier(astPath: ASTPath): boolean;
...
export declare function isLocalizationHelperTranslationName(focusPath: ASTPath, type: 'script' | 'template'): boolean;
